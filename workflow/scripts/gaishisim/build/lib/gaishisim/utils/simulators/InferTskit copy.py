...
class InferTskit:
    ...
    def _prepare_variant_data(self):
        ...
        vdata = tsinfer.VariantData(self.zarr_file)
        ...
        # from ts
        # --------------------------
        elif self.ancestral_mode == "from_ts":
            ...
            if self.check_ancestral_state:
                if ts_true.num_sites != vdata.num_sites:
                    raise ValueError(
                        "Site count mismatch between tsinfer input and ts file"
                    )
