...
from gaishisim.parsers.simulate_parsers import add_simulate_parsers
...
def _gaishisim_cli_parser() -> argparse.ArgumentParser:
    """
...
def main(arg_list: list = None) -> None:
    """
    Main entry for gaishisim.

    Parameters
    ----------
    arg_list : list, optional
        A list containing arguments for gaishisim. Default: None.

    """
    _set_sigpipe_handler()
    parser = _gaishisim_cli_parser()
